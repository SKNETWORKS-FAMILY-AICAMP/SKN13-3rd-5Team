...
- **다양한 입력 표현 대응**: 자연어 처리 강화 및 유사 질문 처리 로직 보완ㅁ
...
### 9️⃣ 성능 개선 노력
- **할루시네이션 현상**: 최초 모델의 경우 Google place API만을 활용하여 할루시네이션 현상 발생/Naver search를 활용하여 보다 정확한 정보 제공


### 🔟 추후 개선점
- **정확한 정보 제공**: Naver search를 활용했음에도 불구하고 아직 남아있는 할루시네이션 오류
