...
📌 1. 기존 정보의 한계
- 문화유산 정보는 대부분 정적이고 일방향적

- 현장에서 궁금한 점이 생겨도 즉각적인 설명을 듣기 어려움

- 사용자가 스스로 검색하고 해석해야 하는 불편함 존재

📌 2. 데이트·여행 시 실질적인 어려움
- 낯선 장소에서 코스를 직접 짜는 것 자체가 부담

- 날씨, 거리, 이동 시간까지 고려해야 해 계획이 복잡함

- 원하는 정보가 흩어져 있어 여러 앱을 번갈아 확인해야 함
